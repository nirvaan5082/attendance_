...
@media (max-width: 600px) {
	...
	button {
		...
		border-radius: 15px;
		border: none;
		background: #07dede; /* Tomato color background */
		color: blue;
		width: 100%;
		margin: 18px 0;
 ...
 /* Result header */
        ...
        #attendanceResults h3 {
            font-size: 16px;
            color: #deda07; /* Tomato for headers */
            margin-bottom: 15px;
        }
        ...
        #attendanceResults li strong {
            color: #09abba; /* Tomato for subject names */
        }
	...
	<body>
		...
		<div class="container">
			<h1>Attendance for NGITians Batch 2024-28</h1>
	...
	document.getElementById("attendanceForm").addEventListener("submit", function(event) {
		...
		<!-- Footer -->
		<div id="footer">
			<p>Designed by <strong><a href="https://www.instagram.com/nirvaansadhineni_5082" target="_blank" style="color: #510487; text-decoration: none;">Nirvaan Sadhineni</a></strong></p>
		</div>
	<!-- Floating Greeting -->
	<div id="floatingGreeting" style="display: none;"></div>
        <img src="images/download.jpg" alt="NGITians" width="100">
